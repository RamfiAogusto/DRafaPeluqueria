...
function Redes_cont() {
    return (
        <div className="w-full p-2 block mt-10 mb-4 gap-1 justify-around lg:flex flex-row">
            {/* ###############horarios, dirección y teléfono####################### */}
            <div className="block w-full md:flex-auto lg:flex lg:flex-wrap lg:w-2/3">
                {/* -------------------------------Horarios------ */}
                <div className="relative w-full flex flex-nowrap gap-1 justify-center lg:w-1/2 lg:flex-wrap">
                    <h3 className="absolute min-w-60 text-center -top-10 fuentePrecios md:text-2xl">
                        Horarios de atención
                    </h3>
                    <a
                        href="#"
                        role="alert"
                        className="alert w-1/2 border-0 bg-transparent lg:w-full lg:max-h-20"
                    >
                        <svg
                            className="w-10 h-10"
                            width="800px"
                ...
                <div className="w-full flex flex-nowrap gap-1 justify-center lg:w-1/2 lg:flex-wrap">
                    <a
                        href="#"
                        role="alert"
                        className="alert border-0 bg-transparent lg:max-h-20"
                    >
                        <svg
                            className="w-10 h-10"
                            width="800px"
                        ...
                        <div>
                            ...
                            <div className="text-xs">
                                Respaldo Calle 4, Ensanche Carmelita
                            </div>
                        </div>
                    </a>
                    <a
            ...
            {/* ------------------------------------Redes */}
            <div className="flex w-full flex-nowrap justify-center gap-1 lg:flex-wrap lg:w-1/3">
                <a
                    href="#"
                    role="alert"
                    className="alert mb-1 bg-transparent border-0 lg:w-full lg:max-h-20 lg:flex-wrap"
                >
                ...
                <a
                    href="#"
                    role="alert"
                    className="alert mb-1 bg-transparent border-0 lg:w-full lg:max-h-20"
                >
                    <div className="indicator p-1 bg-none">
                        <span className="indicator-item w-6">
